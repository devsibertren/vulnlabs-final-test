<?php
    ...
    $query = "SELECT * FROM user WHERE email = '" . $_SESSION['email_user'] . "'";
    ...
    if (isset($_POST['username'])) {
        ...
        $query1 = "UPDATE daftar_barang SET created_by='". $username ."' WHERE created_by='$username'";
        $query2 = "UPDATE user SET username='". $username ."' WHERE id='$id'";
                    ...
                    <form action="profile.php" method="post" class="user">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user" name="username" value="<?php echo htmlspecialchars($yy['username'], ENT_QUOTES); ?>">
                                <button type="submit" class="btn btn-primary btn-user btn-block mt-3" href="logout.php">Edit Data</button>
                            </div>
                            <div class="col-sm-12 col-md-4">
                                <label for="email">email</label>
                                <input type="text" class="form-control form-control-user" name="email" value="<?php echo htmlspecialchars($yy['email'], ENT_QUOTES); ?>" readonly>
                            </div>
                        </div>
                        <hr>
                    </form>
