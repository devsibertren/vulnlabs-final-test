<?php
    ...
    if (isset($_SESSION['status_login_admin'])) {
        echo 'Session "username" tersimpan dengan nilai: ' . $_SESSION['status_login_admin'];
    } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="cek-add-data.php" method="post" class="user">
                        <div class="row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="nama_barang">Nama Barang: </label>
                                <input type="text" class="form-control form-control-user" id="nama_barang"
                                    placeholder="Nama Barang" name="nama_barang" value="<?php echo htmlspecialchars("",ENT_QUOTES); ?>">
                            </div>
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="nama_barang">Deskripsi barang: </label>
                                <input type="text" class="form-control form-control-user" id="deskripsi_barang"
                                    placeholder="Deksripsi Barang" name="deskripsi_barang" value="<?php echo htmlspecialchars("",ENT_QUOTES); ?>">
                            </div>
                            <div class="col-sm-6">
                                <label for="kuantitas">Kuantitas</label>
                                <input type="text" class="form-control form-control-user" id="kuantitas"
                                    placeholder="Kuantitas" name="kuantitas" value="<?php echo htmlspecialchars("",ENT_QUOTES); ?>"pattern="[0-9]+">
                        </div>
                        <div class="col-sm-6">
                                <label for="kuantitas">Harga</label>
                                <input type="text" class="form-control form-control-user" id="harga"
                                    placeholder="harga" name="harga" value="<?php echo htmlspecialchars("",ENT_QUOTES); ?>"pattern="[0-9]+">
                        </div>
                        <input type="hidden" name="created_by" value="<?php echo $_SESSION['username_admin'] ?>">
                        
                        <button type="submit" class="btn btn-primary btn-user btn-block mt-3">add Data</button>
                        <hr>
                    </form>
                </div>
            </div>
